...
const expectedOrder = [
  ...
  'js/ui.js', 'js/ui-adventure.js', 'js/ui-progress.js', 'js/ui-contracts.js', 'js/ui-specializations.js', 'js/ui-bosses.js', 'js/ui-chronicle.js', 'js/ui-pacing.js', 'js/ui-action.js', 'js/ui-siege.js', 'js/ui-battle.js', 'js/ui-action-combat.js', 'js/main.js'
];
...
test('Systemmodule bleiben DOM-frei und Kernmonolithen unter den vereinbarten Grenzen', async () => {
  ...
  const chronicle = await Bun.file(root + '/js/systems-chronicle.js').text();
  const pacing = await Bun.file(root + '/js/systems-pacing.js').text();
  ...
  [systems, bestiary, contracts, specializations, bosses, chronicle, pacing, combat, skirmish, completion].forEach(function (source) {
  ...
  expect(lines(chronicle)).toBeLessThan(620);
